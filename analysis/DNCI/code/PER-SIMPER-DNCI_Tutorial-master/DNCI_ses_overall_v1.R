...
DNCI.ses_overall <- function(x, grouping, id = "no_name", Nperm = 1000, dataTYPE = "count", count = TRUE, plotSIMPER = TRUE) { #this calculates the metric using PERSIMPER - now the output included DELTAd-n, sd of DELTA.d-n and confidence interval

  results = PerSIMPER_overall(x, grouping, count = count, Nperm = Nperm, dataTYPE = "count", plotSIMPER = plotSIMPER)
