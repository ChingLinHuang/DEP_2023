...
DNCI.ses <- function(x, grouping,id = "no_name", Nperm = 99, count = TRUE, plotSIMPER = FALSE, dataTYPE = "count") { #this calculates the metric using PERSIMPER - now the output included DELTAd-n, sd of DELTA.d-n and confidence interval
